...
run_log "Restart front-envoy with FRONT_ENVOY_YAML=http-service.yaml"
docker-compose down
FRONT_ENVOY_YAML=http-service.yaml docker-compose up -d
sleep 10
...
run_log "Restart front-envoy with FRONT_ENVOY_YAML=opa-service.yaml"
docker-compose down
FRONT_ENVOY_YAML=opa-service.yaml docker-compose up -d
sleep 10
